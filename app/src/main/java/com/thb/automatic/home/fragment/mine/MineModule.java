 ...
 */
package com.thb.automatic.home.fragment.mine;

import com.thb.automatic.home.fragment.mine.contract.MineContract;
import com.thb.automatic.home.fragment.mine.model.MineModel;
import dagger.Binds;
...
public abstract class MineModule {
    ...
    @Binds
    abstract MineContract.Model bindMapModel(MineModel model);
