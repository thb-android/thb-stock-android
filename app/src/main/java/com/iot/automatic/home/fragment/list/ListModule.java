 ...
 */
package com.iot.automatic.home.fragment.list;

import com.iot.automatic.home.fragment.list.contract.ListContract;
import com.iot.automatic.home.fragment.list.model.ListModel;
import dagger.Binds;
...
public abstract class ListModule {
    ...
    @Binds
    abstract ListContract.Model bindMapModel(ListModel model);
